...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"wr", false,-1, 8,0);
    tracep->declBus(c+4,"rd", false,-1, 8,0);
    ...
    tracep->declBus(c+6,"mic_signal", false,-1, 7,0);
    tracep->declBus(c+7,"delayed_signal", false,-1, 7,0);
    tracep->declBus(c+8,"read_addr", false,-1, 8,0);
    ...
    tracep->declBus(c+8,"read_addr", false,-1, 8,0);
    tracep->declBus(c+9,"write_addr", false,-1, 8,0);
    tracep->declBus(c+6,"data_in", false,-1, 7,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+3,(vlSelf->wr),9);
    bufp->fullSData(oldp+4,(vlSelf->rd),9);
    ...
    bufp->fullSData(oldp+8,(vlSelf->sigdelay__DOT__read_addr),9);

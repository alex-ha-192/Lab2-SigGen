...
VL_ATTR_COLD void Vsigdelay___024root___initial__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->sigdelay__DOT__read_addr = vlSelf->rd;
    vlSelf->sigdelay__DOT__write_addr = (0x1ffU & ((IData)(vlSelf->rd) 
                                                   - (IData)(vlSelf->offset)));
}
...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->wr = VL_RAND_RESET_I(9);
    vlSelf->rd = VL_RAND_RESET_I(9);
